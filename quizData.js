/**
 * Quiz data structure containing all practice tests
 * @type {Object.<number, {title: string, questions: Array.<{type: string, text: string, correct: boolean|number, explanation: string, options?: string[]}>}>}
 */
const quizData = {
    1: {
        ...
        questions: [
            ...
            },
            {
                ...
                options: [
                    ...
                    "The primitive is converted into a set of fragments (potential pixels) covering its area, with interpolated attributes (color, depth, etc.).",
    ...
    3: {
        ...
        questions: [
            // ... Copy all questions from quiz 3 ...
        ]
    },
    4: {
        title: "Practice Mid-Semester Test 4",
        questions: [
            // ... Copy all questions from quiz 4 ...
        ]
    },
    5: {
